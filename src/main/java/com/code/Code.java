...
public class Code {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(data);
		 ...
		 String creditAccountNo=getField(data ,"Credit Account No");
		 String remarks=getField(data,"Remarks");
		 String debitAccountNo=getField(data ,"Debit Account");
		...
		AccountDetails td=new AccountDetails(payeeName,nickName,creditAccountNo,remarks,debitAccountNo,date,amount,paymentType,payVia);
